...
CREATE TABLE `super` (
  ...
  `super_id` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `super_pw` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_aurvp9yqux6jtliw9twlelkyj` (`super_id`)
...
INSERT INTO `super` VALUES (1,'super','super');
