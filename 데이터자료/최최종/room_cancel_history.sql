...
CREATE TABLE `cancel_history` (
  `cancell_id` int NOT NULL AUTO_INCREMENT,
  `amount` int NOT NULL,
  ...
  KEY `FK2ia211le52yibij47kq1ug6dl` (`payment_id`),
  CONSTRAINT `FK2ia211le52yibij47kq1ug6dl` FOREIGN KEY (`payment_id`) REFERENCES `payment` (`payment_id`)
